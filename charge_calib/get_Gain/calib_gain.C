...
void calib_gain()
{
  ...
  const int nn = 7;
TString fname[nn] = { "Ge68" , "AmC" , "photon_11522" , "Co60" , "Cs137" , "photon_22000" , "Averaged" };
TString fname2[nn] = { "Ge68" , "AmC" , "photon_11522" , "Co60" , "Cs137" , "photon_22000" , "Averaged" };
...
//
  ...
  for (int i = 0; i < npmt; i++) outf << i << "\t" << gainth[nn - 1]->GetBinContent(i + 1) << "\t" << endl;
}
